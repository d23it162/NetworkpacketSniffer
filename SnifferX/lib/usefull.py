...
def printPacket(Object,option):
    ...
    if option == '3':  # Print packet in hex format
        ...
        if eth_proto == 8:  # ipv4
            ...
            print("\tversion:{}  header_length:{}Bytes".format(Object.version, Object.headerLength), " Type_of_Service[TOS]:", Object.typeOfService, 
                  " Total_Length:{}".format(Object.totalLength), " Identification:", Object.identification, 
                  " Reserverd_bit[x]:", Object.reservedBit, " Don't_fragment[d]:", Object.dontFragment, 
                  " More_fragments[m]:", Object.moreFragment, " Fragment_offset:", Object.fragmentOffset, 
                  " time_to_leave[TTL]:", Object.timeToLeave, " protocol:", Object.protocol, 
                  " Header_Checksum:0x%x" % Object.headerChecksum, " source:", Object.source, 
            ...
            if proto == 1:  # icmp -- ipv4
                ...
                print("\tType:", Object.Type, "  Max_Resp_Time:", Object.Max_Resp_Time, 
                      "  Checksum:", Object.Checksum, "  Group_address:", Object.Group_address)
            elif proto == 6:  # tcp -- ipv4
                print(blue_color, "[*]Transmission control Protocol[TCP]", end_color, ": [", pink_color, 
                      Object.tcp_Source_Port, " ==> ", Object.tcp_Destination_Port, end_color, "]")
                InitData = "\tSrc Port:" + str(Object.tcp_Source_Port) + "  Dest Port:" + str(Object.tcp_Destination_Port) + \
                           "  Seq Num:" + str(Object.tcp_Seq_Num) + "  Ack Num:" + str(Object.tcp_Ack_Num) + "  Header Len:" + str(Object.tcp_Header_Length)
                tcp_flags = blue_color + "  FLAGS:- " + end_color

                # Flag checks
                tcp_flags += green_color + " RESERVED:" + str(Object.tcp_Res_Flag) + end_color if Object.tcp_Res_Flag else " RESERVED:0"
                tcp_flags += green_color + " NOUNCE:1" + end_color if Object.tcp_Nounce_Flag else " NOUNCE:0"
                tcp_flags += green_color + " CWR:1" + end_color if Object.tcp_CWR_Flag else " CWR:0"
                tcp_flags += green_color + " ECN:1" + end_color if Object.tcp_ECN_Flag else " ECN:0"
                tcp_flags += green_color + " URG:1" + end_color if Object.tcp_Urgent_Flag else " URG:0"
                tcp_flags += green_color + " ACK:1" + end_color if Object.tcp_Ack_Flag else " ACK:0"
                tcp_flags += green_color + " PUSH:1" + end_color if Object.tcp_Push_Flag else " PUSH:0"
                tcp_flags += green_color + " RESET:1" + end_color if Object.tcp_Reset_Flag else " RESET:0"
                tcp_flags += green_color + " SYN:1" + end_color if Object.tcp_Syn_Flag else " SYN:0"
                tcp_flags += green_color + " FIN:1" + end_color if Object.tcp_Fin_Flag else " FIN:0"
                print(InitData, tcp_flags, "  Wnd Size:", Object.tcp_Window_Size, 
                      "  Checksum:", Object.tcp_Checksum, "  Urg Pointer:", Object.tcp_Urgent_Pointer)

                if Object.tcp_Options != "":
                    print(Object.tcp_Options)
                ...
                if Object.level4_packet_type == "HTTP":
                    ...
                    if Object.Source_Port == '1900' or Object.Destination_Port == '1900':  # SSDP
                        ...
                        print('{:<6} '.format('DHCPV6 Not Implemented yet!'))
                        ...
                        print(red_color + "Data to this UDP port hasn't been implemented yet!" + end_color)
                else:
                    data_3 = data_2
                ...
                print(red_color + "This is an IPv6 packet..! You haven't Implemented yet!" + end_color)
            else:  # EEE 802.1Q (0x8100)
                print(red_color + "This is an EEE 802.1Q packet...! You haven't Implemented yet!" + end_color)

                # Single line packet printing
        elif option == '1':  # Print packet in a single line
            ...
            if eth_proto == 8:  # IPv4
                ...
                if proto == 1:  # ICMP -- IPv4
                    ...
                    if packet_type == 'TCP':
                        ...
                        data += data_tmp[:15] if len(data_tmp) > 20 else data_tmp
                        ...
                        if Object.Source_Port == '1900' or Object.Destination_Port == '1900':  # SSDP
                            ...
                            msgtype = "Not known"
                            if 'Message_type:Discover' in Object.options:
                                msgtype = 'Discover'
                            elif 'Message_type:Offer' in Object.options:
                                msgtype = 'Offer'
                            elif 'Message_type:Request' in Object.options:
                                msgtype = 'Request'
                            elif 'Message_type:Decline' in Object.options:
                                msgtype = 'Decline'
                            elif 'Message_type:Pack' in Object.options:
                                msgtype = 'Pack'
                            elif 'Message_type:Pnak' in Object.options:
                                msgtype = 'Pnak'
                            elif 'Message_type:Release' in Object.options:
                                msgtype = 'Release'
                            elif 'Message_type:Inform' in Object.options:
                                msgtype = 'Inform'
                                ...
                                data += red_color + "Data to this UDP port hasn't been implemented yet!" + end_color
                        ...
                        data += red_color + "This is an IPv6 packet..! You haven't Implemented yet!" + end_color

                    else:  # EEE 802.1Q (0x8100)
                        data += red_color + "This is an EEE 802.1Q packet...! You haven't Implemented yet!" + end_color
